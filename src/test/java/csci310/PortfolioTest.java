...
public class PortfolioTest {
	...
	public void testAddStock() throws ParseException {
		...
		p.addStock("IBM",  "10/07/2020", "10/08/2020");
	...
	public void testDeleteStock() throws ParseException {
		...
		p2.addStock("IBM",  "10/07/2020", "10/08/2020");
		p2.deleteStock("IBM");
	...
	public void testPopulatePortfolioValue1() throws ParseException, IOException {
		...
		p3.addStock("IBM",  "10/07/2020", "10/08/2020");
		p3.addStock("RACE",  "10/01/2020", "10/10/2020");
	...
	public void testPopulatePortfolioValue2() throws ParseException, IOException {
		...
		p4.addStock("IBM",  "10/09/2020", "10/16/2020");
		p4.addStock("RACE",  "10/01/2020", "10/06/2020");
	...
	public void testPopulatePortfolioValue3() throws ParseException, IOException {
		...
		p5.addStock("RACE",  "10/05/2020", "10/05/2020");
		p5.addStock("RACE",  "10/07/2020", "10/07/2020");
		p5.addStock("RACE",  "10/09/2020", "10/09/2020");
